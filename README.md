...
The upfront time and resource expense is large, but once you factor in how much work the algorithm is actually doing for you it pays for itself eventually. 
